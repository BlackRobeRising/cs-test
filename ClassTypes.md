...
**Moderate**:
Tremble, Wytch. (Ex): The first time an opponent casts a spell or uses a SLA, the Wytchfinder may make a demoralize attempt as an immediate action. This can only be used once per opponent per combat.
